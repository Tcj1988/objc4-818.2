...
//class BeeHive;
//char * kname_mod __attribute((used, section("__DATA,"#sectname" "))) = ""name"";
//
//char * kservicename_service __attribute((used, section("__DATA,"#sectname" "))) = "{ \""#servicename"\" : \""#impl"\"}"  key - value
// macho - readimage 读取
