...
void add_class_to_loadable_list(Class cls)
{
    ...
    method = cls->getLoadMethod();//获取load方法
...
void add_category_to_loadable_list(Category cat)
{
    ...
    method = _category_getLoadMethod(cat);//获取非懒加载分类中的load方法
...
void call_load_methods(void)
{
    ...
    do {
        ...
        // 2. Call category +loads ONCE 调用一次分类的+load
